...
public class TexasHoldem implements Logic
{
	...
	private final long TIME_PER_MOVE = 1000l; 		// time in milliseconds that bots get per move
	private final long TIMEBANK_MAX = 50000l;		// time bank each bot receives
...
//        System.out.println("starting game ...");
	...
	public void saveGame() throws Exception {
		...
		if (resultsWriter != null) {
			...
			else if(winner.equals(players.get(1))) {
				resultsWriter.write(""+2+"\n");
			}
			else {
	...
	private static FileWriter resultsWriter = null;
	...
	{	
		...
		int games = 10;
		try {
			resultsWriter = new FileWriter("results.txt");
		}
		catch (IOException e) {
		}
